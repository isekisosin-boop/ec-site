...
products_data = {
    1: {
        "name": "商品名1が入ります",
        "category": "口腔ケア",
        "description": "ペットの毎日のケアをサポートする商品の説明が入ります。",
        "price": "¥0,000",
        "detail": "商品の詳しい説明、特徴、使用方法、注意事項などをここに掲載します。",
    ...
    2: {
        "name": "商品名2が入ります",
        "category": "スキンケア",
        "description": "ペットの肌や被毛のケアをサポートする商品の説明が入ります。",
        "price": "¥0,000",
        "detail": "商品の詳しい説明、特徴、使用方法、注意事項などをここに掲載します。",
        "features": "商品の特徴がここに入ります。商品の魅力やポイントを掲載します。",
        "usage": "使用方法がここに入ります。使用する量や使用するタイミングなどを掲載します。",
    ...
    3: {
        "name": "商品名3が入ります",
        "category": "シャンプー",
        "description": "ペットとの毎日のケアに使いやすい商品の説明が入ります。",
        "price": "¥0,000",
        "detail": "商品の詳しい説明、特徴、使用方法、注意事項などをここに掲載します。",
        "features": "商品の特徴がここに入ります。商品の魅力やポイントを掲載します。",
        "usage": "使用方法がここに入ります。使用する量や使用するタイミングなどを掲載します。",
